...
public class FPSInputController : MonoBehaviour
{
	...
	void Start ()
	{
		...
		//sultan Screen.lockCursor = true;
	}

	void Awake ()
	{
		screenRatio = (double)Screen.width / (double)Screen.height;
	...
	void Update ()
	{
		...
		FPSmotor.Move (new Vector3 (CnControls.CnInputManager.GetAxis ("Horizontal"), 0, CnControls.CnInputManager.GetAxis ("Vertical")));
		FPSmotor.Jump (Input.GetButton ("Jump"));
