...
namespace CnControls
{
...
#endif
    {
		...
		public RectTransform baseStart;
		public RectTransform stickStart;
        ...
        private void Awake()
        {
			...
			baseStart = _baseTransform;
			stickStart = _stickTransform;
		...
		public void ResetVal(){
			...
			_stickTransform.anchoredPosition = new Vector2 (0, 0);
			_initialStickPosition = _stickTransform.anchoredPosition;
